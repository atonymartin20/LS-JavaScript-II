...
runners.forEach(runner => ticketPriceArray.push(runner.donation))
ticketPriceTotal = ticketPriceArray.reduce(sumAll)
...
// Problem 1
// We would like to add everyone to our email list but we don't want to know how much they donated or anything other than their email.  HALP!!!
let emailList = [];
...
// Problem 2
// Wordtune and Zoomcast have teamed up for a special promotion.  We need to alert the runners from those companies about this promotion.

let ZoomcastWordtunePromo = [];
ZoomcastWordtunePromo = runners.filter( runner => runner.company_name === "Wordtune" || runner.company_name === "Zoomcast");
console.log(ZoomcastWordtunePromo);

// Problem 3
// Everyone who donated over 100 should recieve a free reward.  We need a list of everyone who donated over 100.
let largeDonation = [];
largeDonation = runners.filter(runner => runner.donation > 100)
